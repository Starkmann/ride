 ...
 */
 class Address {
 	 ...
 	 */
 	public function updateCoordinates(\Eike\Ride\Domain\Model\Address $address, $forceUpdate = false){
 		if($address->getLatitude() == "" || $address->getLongitude() == "" || $forceUpdate){
	 		$base = "https://nominatim.openstreetmap.org/search/";
	 		$format = "json";
	 		$query =urlencode($address->getStreet()." ".$address->getStreetNumber().", ".$address->getZip()." ".$address->getCity());
