...
/**
 * Test case for class Eike\Ride\Controller\AddressController.
 *
...
class AddressControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Eike\Ride\Controller\AddressController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Eike\\Ride\\Controller\\AddressController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllAddressesFromRepositoryAndAssignsThemToView()
	{
		...
		$addressRepository = $this->getMock('Eike\\Ride\\Domain\\Repository\\AddressRepository', array('findAll'), array(), '', FALSE);
